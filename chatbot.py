...
#creating a dictionary that maps each word to its occurance
word2count={}
...
for word,count in word2count.items():
    if count>=threshold:
        ...
        word_number+=1
#Adiding the last tokens to these two dictionaries
...
#translating all qs and asw into int
...
#sorting qns and ans by length of questions
